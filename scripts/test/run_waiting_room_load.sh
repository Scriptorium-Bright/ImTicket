...
SEAT_IDS="${SEAT_IDS:-}"
SEAT_MAP_FALLBACK_REJECTION_EXPECTED="${SEAT_MAP_FALLBACK_REJECTION_EXPECTED:-false}"
...
k6 run \
  ...
  -e "SEAT_IDS=${SEAT_IDS}" \
  -e "SEAT_MAP_FALLBACK_REJECTION_EXPECTED=${SEAT_MAP_FALLBACK_REJECTION_EXPECTED}" \
