...
public class SeatService {
    ...
    /**
     * 현재 요청의 lock 전략이 DB 비관적 잠금을 요구하는지 확인한다.
     * AOP context 값이 없으면 애플리케이션 설정의 기본 전략을 해석한다.
     */
    ...
    /**
     * 공연에 정의된 좌석 등급별 가격을 map으로 변환한다.
     * 좌석 템플릿 처리에서 등급별 가격을 상수 시간에 찾게 한다.
     */
    @NotNull
    ...
    /**
     * 좌석 템플릿에 등급 가격과 기본 AVAILABLE 상태를 적용한다.
     * 공연 회차에 연결된 새 Seat entity를 반환한다.
     */
